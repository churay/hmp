...
PROJ_EXE = $(BIN_DIR)/hmp
PROJ_MAIN = $(SRC_DIR)/hmp.cpp
...
hmp : $(PROJ_EXE)
$(PROJ_EXE) : $(PROJ_MAIN) $(BIN_DIR)/platform.o $(BIN_DIR)/path.o $(BIN_DIR)/timer.o $(BIN_DIR)/memory.o $(BIN_DIR)/hmplib.so | $(BIN_DIR) $(OUT_DIR)
